      ...
      <section className="bg-gray-800 fixed form-container top-1/2 left-1/2 overflow-hidden">
        <form onSubmit={handlSubmit}>
          <header className="bg-gray-700 text-gray-50 flex items-center p-2 px-3">
            ...
            <div className="shrink-0 font-semibold flex justify-center text-black cursor-pointer items-center sm:mr-3 py-2 px-5 bg-blue-300 rounded-full hover:bg-blue-500 hover:text-gray-50 transition ease-out duration-100">
          ...
          <div className="py-6 flex flex-col justify-center items-center">
            <div className="bg-blue-900 text-gray-100 w-20 h-20 flex flex-col justify-center items-center rounded-full text-3xl cursor-pointer">
              <button className="text-3xl"><BiImageAdd /></button>
            </div>
